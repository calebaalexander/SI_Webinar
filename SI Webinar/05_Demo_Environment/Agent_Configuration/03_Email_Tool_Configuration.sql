-- Email Sender Tool Configuration for PawCore Systems Business Intelligence Agent
...
SELECT PAWCORE_INTELLIGENCE_DEMO.AGENTS.FORMAT_EMAIL_CONTENT(
    'PawCore Systems Sales Performance Report - Q1 2024',
    CONCAT(
    ...
    'PawCore Systems Pet Wellness - Business Intelligence Report'
...
SELECT PAWCORE_INTELLIGENCE_DEMO.AGENTS.FORMAT_EMAIL_CONTENT(
    ...
    'PawCore Systems Marketing Intelligence Report'
...
SELECT PAWCORE_INTELLIGENCE_DEMO.AGENTS.FORMAT_EMAIL_CONTENT(
    ...
    'PawCore Systems Operations Intelligence Report'
) AS operations_report_template;

-- Agent Tool Integration Instructions
/*
To integrate the email_sender tool with the PawCore Systems Business Intelligence Agent:
...
SELECT 
    ...
    CASE 
        WHEN EXISTS (
            ...
            WHERE INTEGRATION_NAME = 'PAWCORE_EMAIL_INT' AND ENABLED = TRUE
...
SELECT 
    ...
    CASE 
        WHEN EXISTS (
            SELECT 1 FROM PAWCORE_INTELLIGENCE_DEMO.INFORMATION_SCHEMA.PROCEDURES 
...
SELECT 
    ...
    CASE 
        WHEN EXISTS (
            SELECT 1 FROM PAWCORE_INTELLIGENCE_DEMO.INFORMATION_SCHEMA.FUNCTIONS 
